...
#
# Exercice 2.8
# Compte à rebours 'verbose' de 20 à 1 avec temps d'attente et explosion
#
# Auteur:   Lawrence Haesler
# Date:     20.01.2026

print("Orif section informatique - Exercice 2.8 - Lawrence Haesler")
...
for x in range(10, 0, -1):          
    print("Plus que", x, "secondes avant explosion ...")
    time.sleep(1)  
